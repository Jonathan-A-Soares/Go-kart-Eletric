...
void printKARTInfo()
{
    ...
    Serial.print("voltagem bateria 1 :");
    Serial.println(bat, 5);
    ...
    Serial.print("voltagem bateria 2 :");
    Serial.println(bat2, 5);
    if (bat2 >= 11.5)
    {
